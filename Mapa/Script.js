var template_path = Qva.Remote + "?public=only&name=Extensions/MapaIntercement/";
	...
	//if (typeof jQuery === 'undefined') {
	    Qva.LoadScript(template_path + 'jquery-1.7.2.min.js', function () {
			Qva.LoadScript(template_path + 'jquery.vmap.js', function () {
				Qva.LoadScript(template_path + 'jquery.vmap.world.js', extension_Done);
			})
		});
	//}
	//else {
...
//Add extension
		Qva.AddExtension('MapaIntercement', function(){
